...
for K in range(60000):
    ...
    for i in range(4):
        ...
        attack_image = attack(trainX[image_choice],trainY[image_choice],model, pixel_count=100, filter=True, maxiter=300, popsize=700)
    ...
    plt.imsave("./100_FILTER_ADVERSARIAL_DATABASE_DP/" + str(K) + "_" + digits_for_file_name + ".png", new_image, cmap='Greys')
