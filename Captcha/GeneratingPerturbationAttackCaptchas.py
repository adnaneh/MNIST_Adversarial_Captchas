...
from Captcha.MultipleModelOnePixelAttack import *
...
"""
model1 = load_model("./MODELS/LeNet_MNIST_data.hdf5")
model2 = load_model("./MODELS/captcha_model.hdf5")
...
for K in range(60000):
    ...
    for i in range(4):
        ...
        attack_image = attack(trainX[image_choice],trainY[image_choice],models, filter=True, maxiter=300, popsize=700)
    ...
    plt.imsave("./100_FILTER_ADVERSARIAL_HYBRID/" + str(K) + "_" + digits_for_file_name + ".png", new_image, cmap='Greys')
