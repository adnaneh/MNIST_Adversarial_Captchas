...
"""
DP = load_model("./MODELS/captcha_model.hdf5")
LeNet = load_model("./MODELS/LeNet_MNIST_data.hdf5")
...
for K in range(60000):
    ...
    for i in range(4):
        ...
        attack_image = attack(trainX[image_choice],trainY[image_choice], DP, pixel_count=50,
                              filter=True, maxiter=300, popsize=700)
        attack_image = attack_image[0]
        attack_image = attack(attack_image, trainY[image_choice], LeNet, pixel_count=50,
                              filter=True, maxiter=300, popsize=700)
    ...
    plt.imsave("./100_FILTER_HYBRID/" + str(K) + "_" + digits_for_file_name + ".png", new_image, cmap='Greys')
